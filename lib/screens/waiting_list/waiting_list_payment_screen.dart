                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          _buildNavigationButton("CONFIRM AND BOOK", () {
                             Navigator.push(
                              context,
                              FadeRoute(page: const WaitingListConfirmationScreen()),
                            );
                          }),
                        ],
                      ),
      ...
      child: Row(
        ...
        children: [
          Text(
            label,
            style: GoogleFonts.langar(
              color: const Color(0xFF3E2723), // Dark Brown text for summary
              fontWeight: FontWeight.bold,
              fontSize: 14,
            ),
          ),
          Expanded(
            child: Text(
              value, // Value includes space and colon from caller usually
